...
function DelayFunc(WorldContectObject,Induration,func)
    coroutine.resume(coroutine.create(
        function()
            UE4.UKismetSystemLibrary.Delay(WorldContectObject,Induration)
			func()
        end
    ),
    self,Induration)
...
_G.DelayFunc = DelayFunc

function RetriggerableDelayFunc(WorldContectObject,Induration,func)
    coroutine.resume(coroutine.create(
        function()
            UE4.UKismetSystemLibrary.RetriggerableDelay(WorldContectObject,Induration)
			func()
        end
    ),
    self,Induration)
...
_G.DelayFunc = RetriggerableDelayFunc